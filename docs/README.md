...
Hey, are you looking for a containers 101 course? Check out our [Docker Essentials](https://developer.ibm.com/courses/all/docker-essentials-extend-your-apps-with-containers/). Also you can follow [Docker 101 Lab](https://volaka.gitbook.io/docker-101/).
...
1. You must install the CLIs per [https://console.ng.bluemix.net/docs/containers/cs\_cli\_install.html](https://console.ng.bluemix.net/docs/containers/cs_cli_install.html). If you do not yet have these CLIs and the Kubernetes CLI, do [lab 0](https://github.com/volaka/kube101/tree/bf470977788909d418ca40830f565648a89dc640/docs/Lab0/README.md) before starting the course.
